...
)  # (knowis/config/settings/base.py - 3 = knowis/)
...
LOCAL_APPS = [
    ...
    "knowis.question.apps.QuestionConfig",
...
ADMINS = [("""max""", "letnidev@gmail.com")]
# https://docs.djangoproject.com/en/dev/ref/settings/#managers
MANAGERS = ADMINS

# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["knowis.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = 'knowis.users.adapters.AccountAdapter'
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# SOCIALACCOUNT_ADAPTER = 'knowis.users.adapters.SocialAccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
